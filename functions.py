...
class NewRow(QtGui.QFrame):
    def __init__(self, parent=None):
        ...
        self.material_label = QtGui.QLabel("Qty", self)
        ...
        init_format(self.job_number, max_size=QtCore.QSize(150, 24), flat=False, frame=False)
        ...
        init_format(self.material, max_size=None, min_size=None, flat=False, frame=False)
        init_format(self.material_label, flat=False)
        init_format(self.material_qty, max_size=QtCore.QSize(75, 24), flat=False, frame=False)
        ...
        layout.addWidget(self.material_label, 1, 4, 1, 1)
...
def init_format(widget, max_size=QtCore.QSize(75, 50), min_size=QtCore.QSize(50, 24), icon=None, frame=True,
                align=(QtCore.Qt.AlignVCenter | QtCore.Qt.AlignHCenter), flat=True, style="border-width:0px;"):
    if max_size:
