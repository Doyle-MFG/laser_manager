...
class NewRow(QtGui.QFrame):
    def __init__(self, parent=None):
        ...
        self.upload_pdf.setIcon(QtGui.QIcon(":/icons/upload.png"))
        self.upload_pdf.setFlat(True)
        ...
        init_format(self.edit_job, max_size=None, min_size=None, align=None, flat=None,
                    style="border-width:0px;background-color: rgb(255, 255, 255);")
        #self.edit_job.setStyleSheet("background-color: rgb(255, 255, 255);border-width:0px;")
        self.material_qty = QtGui.QLineEdit(self)
        init_format(self.material_qty, max_size=QtCore.QSize(75, 24), flat=False)
        # self.material_qty.setMinimumSize(QtCore.QSize(50, 24))
        # self.material_qty.setMaximumSize(QtCore.QSize(75, 24))
        # self.material_qty.setAlignment(QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter)
        self.job_number = QtGui.QLineEdit(self)
        init_format(self.job_number, flat=False)
        # self.job_number.setStyleSheet("border-width:0px;")
        # self.job_number.setAlignment(QtCore.Qt.AlignCenter)
        self.material = QtGui.QLineEdit(self)
        init_format(self.material, max_size=QtCore.QSize(150, 24), min_size=QtCore.QSize(150, 24), flat=False)
        ...
        # self.print_report.setIcon(QtGui.QIcon(":/icons/printer.png"))
        # self.print_report.setFlat(True)
        self.label = QtGui.QLabel("Qty", self)
        init_format(self.label, flat=False)
        self.notes = QtGui.QPlainTextEdit(self)
        init_format(self.notes, max_size=QtCore.QSize(16777215, 50), align=None, flat=None)
